...
export interface WKASInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WKAS extends BaseContract {
  connect(runner?: ContractRunner | null): WKAS;
  waitForDeployment(): Promise<this>;

  interface: WKASInterface;
