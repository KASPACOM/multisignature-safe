...
import {
  ...
  NetworkConfig as ConstantsNetworkConfig,
} from "./constants";
...
export function createContractNetworksConfig(
  config: ConstantsNetworkConfig
  ...
  console.log("createContractNetworksConfig created:", contractNetworksConfig);
